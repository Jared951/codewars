...
def nb_year(p0, percent, aug, p):
    ...
    # Continue looping until the population reaches or surpasses the target population
    while p0 < p:
        # Update the population using the given formula
        # Convert percent from percentage to decimal by dividing it by 100
    ...
    # Return the total number of years needed
    return years
