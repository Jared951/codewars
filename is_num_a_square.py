...
In mathematics, 
a square number or perfect square is an integer that is 
the square of an integer; in other words, 
...
def is_square(n):    
    ...
    # Calculate the square root using math.isqrt()
